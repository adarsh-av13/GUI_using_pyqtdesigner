...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.lineEdit_4.setText(_translate("Dialog", "BE 101-05", None))
        self.lineEdit_5.setText(_translate("Dialog", "BE 103", None))
        self.lineEdit_6.setText(_translate("Dialog", "EE 100", None))
        self.lineEdit_7.setText(_translate("Dialog", "PH 110", None))
        self.lineEdit_8.setText(_translate("Dialog", "EE 110", None))
        self.lineEdit_9.setText(_translate("Dialog", "CS 110", None))
