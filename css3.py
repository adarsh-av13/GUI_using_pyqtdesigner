...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.lineEdit_2.setText(_translate("Dialog", "CS 201", None))
        self.lineEdit_3.setText(_translate("Dialog", "CS 203", None))
        self.lineEdit_4.setText(_translate("Dialog", "CS 205", None))
        self.lineEdit_5.setText(_translate("Dialog", "CS 207", None))
        self.lineEdit_6.setText(_translate("Dialog", "HS 210", None))
        self.lineEdit_7.setText(_translate("Dialog", "CS 231", None))
        self.lineEdit_8.setText(_translate("Dialog", "CS 233", None))
	...
	#msg.setText("GPA {0:.2f}".format(sum))
