...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.lineEdit.setText(_translate("Dialog", "CS 401", None))
        self.lineEdit_2.setText(_translate("Dialog", "CS 403", None))
        self.lineEdit_3.setText(_translate("Dialog", "CS 405", None))
        self.lineEdit_4.setText(_translate("Dialog", "CS 407", None))
        self.lineEdit_5.setText(_translate("Dialog", "CS 409", None))
        self.lineEdit_6.setText(_translate("Dialog", "Elective 3", None))
        self.lineEdit_7.setText(_translate("Dialog", "CS 451", None))
        self.lineEdit_8.setText(_translate("Dialog", "CS 431", None))
