...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.lineEdit.setText(_translate("Dialog", "ME 402", None))
        self.lineEdit_2.setText(_translate("Dialog", "ME 404", None))
        self.lineEdit_3.setText(_translate("Dialog", "Elective 4", None))
        self.lineEdit_4.setText(_translate("Dialog", "Elective 5", None))
        self.lineEdit_5.setText(_translate("Dialog", "ME 492", None))
