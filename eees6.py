...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.lineEdit.setText(_translate("Dialog", "EE 302", None))
        self.lineEdit_2.setText(_translate("Dialog", "EE 304", None))
        self.lineEdit_3.setText(_translate("Dialog", "EE 306", None))
        self.lineEdit_4.setText(_translate("Dialog", "EE 308", None))
        self.lineEdit_5.setText(_translate("Dialog", "HS 300", None))
        self.lineEdit_6.setText(_translate("Dialog", "Elective 2", None))
        self.lineEdit_7.setText(_translate("Dialog", "EE 352", None))
        self.lineEdit_8.setText(_translate("Dialog", "EE 332", None))
        self.lineEdit_9.setText(_translate("Dialog", "EE 334", None))
