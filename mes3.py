...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.lineEdit_2.setText(_translate("Dialog", "ME 201", None))
        self.lineEdit_3.setText(_translate("Dialog", "ME 203", None))
        self.lineEdit_4.setText(_translate("Dialog", "ME 205", None))
        self.lineEdit_5.setText(_translate("Dialog", "ME 210", None))
        self.lineEdit_6.setText(_translate("Dialog", "HS 200", None))
        self.lineEdit_7.setText(_translate("Dialog", "ME 231", None))
        self.lineEdit_8.setText(_translate("Dialog", "CE 230", None))
