...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.lineEdit.setText(_translate("Dialog", "MA 101", None))
        self.lineEdit_2.setText(_translate("Dialog", "CY 100", None))
        self.lineEdit_3.setText(_translate("Dialog", "BE 110", None))
        self.lineEdit_4.setText(_translate("Dialog", "BE 101-02", None))
        self.lineEdit_5.setText(_translate("Dialog", "BE 103", None))
        self.lineEdit_6.setText(_translate("Dialog", "EC 100", None))
        self.lineEdit_7.setText(_translate("Dialog", "CY 110", None))
        self.lineEdit_8.setText(_translate("Dialog", "EC 110", None))
        self.lineEdit_9.setText(_translate("Dialog", "ME 110", None))
