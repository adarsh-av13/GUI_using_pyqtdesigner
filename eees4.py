...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.lineEdit_2.setText(_translate("Dialog", "EE 208", None))
        self.lineEdit_3.setText(_translate("Dialog", "EE 202", None))
        self.lineEdit_4.setText(_translate("Dialog", "EE 204", None))
        self.lineEdit_5.setText(_translate("Dialog", "EE 206", None))
        self.lineEdit_6.setText(_translate("Dialog", "HS 200", None))
        self.lineEdit_7.setText(_translate("Dialog", "EE 232", None))
        self.lineEdit_8.setText(_translate("Dialog", "EE 234", None))
