...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.lineEdit.setText(_translate("Dialog", "EE 405", None))
        self.lineEdit_2.setText(_translate("Dialog", "EE 401", None))
        self.lineEdit_3.setText(_translate("Dialog", "EE 403", None))
        self.lineEdit_4.setText(_translate("Dialog", "EE 407", None))
        self.lineEdit_5.setText(_translate("Dialog", "EE 409", None))
        self.lineEdit_6.setText(_translate("Dialog", "Elective 3", None))
        self.lineEdit_7.setText(_translate("Dialog", "EE 451", None))
        self.lineEdit_8.setText(_translate("Dialog", "EE 431", None))
