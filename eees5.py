...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.lineEdit.setText(_translate("Dialog", "EE 301", None))
        self.lineEdit_2.setText(_translate("Dialog", "EE 303", None))
        self.lineEdit_3.setText(_translate("Dialog", "EE 305", None))
        self.lineEdit_4.setText(_translate("Dialog", "EE 307", None))
        self.lineEdit_5.setText(_translate("Dialog", "EE 309", None))
        self.lineEdit_6.setText(_translate("Dialog", "Elective 1", None))
        self.lineEdit_7.setText(_translate("Dialog", "EE 341", None))
        self.lineEdit_8.setText(_translate("Dialog", "EE 331", None))
        self.lineEdit_9.setText(_translate("Dialog", "EE 333", None))
